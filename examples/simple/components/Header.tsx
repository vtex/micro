...
import { NavLinkProps } from '@vtex/micro-plugin-react-router/components'

interface Props extends Omit<NavLinkProps, 'to'> {
  to: string
}

export const LinkServer: React.SFC<Props> = ({ to, className, children }) => (
